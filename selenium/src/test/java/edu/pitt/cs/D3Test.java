...
//    driver = new FirefoxDriver();
  ...
  public void dEFECT3FUNGREETACAT() {
    ...
    driver.findElement(By.xpath("//button[contains(.,\'Rent\')]")).click();
    {
      ...
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id=\'listing\']/ul/li[contains(text(), \'Rented out\')]")));
    }
    driver.findElement(By.xpath("//input[@id=\'rentID\']")).click();
    driver.findElement(By.xpath("//input[@id=\'rentID\']")).clear();
    ...
    driver.findElement(By.xpath("//input[@id=\'rentID\']")).click();
    driver.findElement(By.xpath("//input[@id=\'rentID\']")).clear();
    driver.findElement(By.xpath("//input[@id=\'rentID\']")).sendKeys("3");
    driver.findElement(By.xpath("//button[contains(.,\'Rent\')]")).click();
    {
      WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id=\'listing\']/ul/li[contains(text(), \'Rented out\')]")));
    ...
    driver.findElement(By.xpath("//a[contains(@href, \'/greet-a-cat\')]")).click();
    assertThat(driver.findElement(By.xpath("//div[2]/h4")).getText(), is(""));
  }
}
